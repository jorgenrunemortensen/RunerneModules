...
namespace Runerne.Computation.Numeric
{
    ...
    /// </summary>
    public class NumericLessThanOrEquals : IBooleanComputable
    {
        /// <summary>
        ...
        public NumericLessThanOrEquals(INumericComputable left, INumericComputable right)
        {
            Left = left;
            Right = right;
        }
        public NumericLessThanOrEquals(INumericComputable left, double right)
        {
            Left = left;
